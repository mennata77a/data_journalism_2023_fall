...
A1: I found 46 records.

```{r}
# cleaning function
cleaned_payments |>
  filter(str_detect(vendor_name, 'PRINCE GEORGES COUNTY PUBLIC SCHOOL') | str_detect(vendor_name, 'PRINCE GEORGES COUNTY SCHOOL') | str_detect(vendor_name,'PG COUNTY PUBLIC SCHOOL')) |>
