...
**Answer** Here the unique function just showcases the unique list of words that appear--the case differences here matter!
...
**Answer** It shows the "tokens" that appear in that text rather than the unique words--this is a better version of the above because it breaks down every little token
...
**Answer** I don't think this is very interesting--obviously articles are the most commonly used words. 
...
**Answer** Absolutely--this is way more interesting because they're real and big words that give context. I don't think percents matter at all (they're all less than 1). The distance between the percentages are more interesting, while the top ten words are even more interesting than that
...
Those seem like more relevant unique words. Now, here's where we can start to do more interesting and meaningful analysis. Let's create three dataframes of unique words based on time: one for 2021, 2022 and 2023.

### Task 10: Create dataframes for 2021, 2022 and 2023
...
**Answer** This shows the top 10 words in each words. Interesting because it shows how much more or less frequently we talk about certain topics, like COVID, women, fire, etc.
...
**Answer** This is more meaningful to me than single words because it shows us concepts and bigger ideas that were discussed.
...
**Answer** This shows the top concepts for 2022, interesting because covid  and human rights are still high up there! 
...
### Task 14: Create a dataframe with the top 10 two-word phrases for 2023

**Task** Run the following code and describe the results. 

**Answer** Top concepts for 2023! Covid is gone and oral health is so high up there. This shift and introduction of new subjects is very interesting to me.
...
We can see that "covid 19" is no longer a top phrase, and phrases about human rights have taken the lead. "oral health" makes an appearance, too. You'll notice that the percentages are very small; that's not irrelevant but in some cases it's the differences in patterns that's more important.
...
### Task 15: Load the bing lexicon and produce sentiments for our 2021-2023 unique words

**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? 

**Answer** This claims that significant is positive, but in my experience, it rarely has ever really been. Dick being negative is weird? Not that it should be positive either but why was it even in this speech. This sentiment thing feels like--while interesting--maybe not too accurate without the context of the words around it.
