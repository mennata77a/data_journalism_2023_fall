...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? 

**Answer** It thinks the Maryland row is the header?? It very much is not.
...
**Answer** There are no categories listed for the headers, such as the years or the jurisdictions. I also think these .... situtations are ugly but I don't know if we're gonna be able to fix that without doing more work.
...
**Answer** I would still love to get rid of these ...s. They're taking up too much space.
