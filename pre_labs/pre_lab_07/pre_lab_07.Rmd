...
**Answer** Rough Estimates of Household Incomes by Maryland Counties
...
(THIS IS SO WEIRD BECAUSE THIS IS EXACTLY WHAT I WANTED TO KNOW ABOVE -- sorry for the all caps I was in too deep before I realized)

**Answer** Baltimore city saw the largest increases in median income. Although Caroline County had the smallest increase in median income, none of these counties saw their median incomes fall between these years.
...
**Answer** I want to know which zipcode had the high schools with students from the lowest median household income rates and how that correlated with graduation rates
...
**Answer** In the high schools where the rate was at least 60%, there are at least 50 high schools with an average income of $111,338.30. In the high schools where the rate was less than 40%, there are at least 76 high schools with an average income of $69,252.20. That is so stark and jarring oh my god???
...
**Answer** I want to know if there are any outliers in this dataset, which counties they are in, and why they seem to be the way they are.
